    ...
    function filtrarTramiteAtendidoEnviado(){
        ...
        $.get(`/adminContratos/filtrarAtendidoEnviado/${iddepartamento}/${idtipo_tramite}/${nivelAtencion}`, function(retorno){
    ...
    function recuperarTramite(iddetalle_tramite){
        ...
        function(isConfirm){
            ...
            if(isConfirm){ // si dice que quiere eliminar
                ...
                $.get("/adminContratos/recuperarTramite/"+iddetalle_tramite, function(retorno){
                    vistacargando();
                    alertNotificar(retorno.resultado.mensaje, retorno.resultado.status);
                    if(!retorno.error){
                        vistacargando("M","Espere...");
                        window.location.href="/adminContratos/atendidosEnviados";
                    }
                }).fail(function(){
                    vistacargando();
                });
