    ...
    // funcion para agregar departamentos de la lista 
    function agregarDepartamentoLista(iddepartamento_encrypt,iddep, iddetalle_tramite_atender){
    ...
    $("#frm_redireccionarAdminContrato").submit(function(e){
                ...
                $.ajax({
                    ...
                    success: function(retorno){
                        ...
                        if(!retorno.error){
                            ...
                            window.location.href = "/adminContratos/editarDetalleTramiteReasignado?iddetalle_tramite="+retorno.iddetalle_tramite;
                        }                       
                    },
                    error: function(){
                        vistacargando(); // ocultamos la ventana de espera
