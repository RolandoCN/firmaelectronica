...
function verTramite(iddetalle_tramite){
    ...
    $.get("/tramite/detalleTramite/"+iddetalle_tramite, function(retorno){
        ...
        if(retorno.detalle_tramite.reasignado==1){
            $("#btn_elaboracion_editar").prop('href', '/adminContratos/editarDetalleTramiteReasignado?iddetalle_tramite='+iddetalle_tramite);
        }else{
            $("#btn_elaboracion_editar").prop('href', '/adminContratos/editarDetalleTramite?iddetalle_tramite='+iddetalle_tramite);
        }
