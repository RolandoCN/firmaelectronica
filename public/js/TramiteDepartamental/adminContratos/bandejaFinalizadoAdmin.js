    ...
    function verTramite(iddetalle_tramite, iddetalle_actividad){
        ...
        $("#btn_finalizados_revertir").attr('onclick',`revertirTramite('${iddetalle_tramite}')`);
    }
    ...
    function filtrarTramiteAtendidoIniciado(){
        ...
        $.get(`/adminContratos/filtrarFinalizado/${iddepartamento}/${idtipo_tramite}`, function(retorno){
    ...
    function revertirTramite(iddetalle_tramite_encrypt){
        ...
        function(isConfirm) {
            if(isConfirm){ // si dice que quiere eliminar
                ...
                $.get("/adminContratos/revertirTramite/"+iddetalle_tramite_encrypt, function(retorno){
