...
// FUNCIONES PARA CARGAR LOS COMBOS DE LA VENTANA DE DEFINICION DE FLUJO
    ...
    function cargar_cmb_departamentos(){
        var idTipoTram=$("#gf_select_tipo_tramite").val();
        var idPeriodo=$("#gf_select_periodo").val();
        ...
        // mostramos el boton finalizar, documento, actividades
            $("#content_finalizar_add_cod_act").show();
        
        // validamos por si no se selecciona un tipo de tramite
        if(idTipoTram=="" || idPeriodo==""){
        ...
        $.get(`/flujo/filtrarFlujoYDepartamentosPorTipoTramite/${idTipoTram}/${idPeriodo}`,function(resultado){
            vistacargando(); // quitamos la ventana de espera
    ...
    function cargar_actividades_modal(cmb_dep_destino){
        ...
        $.get(`/flujo/filtrarActividadesPorDepartamento/${idDepartamentoDestino}`,function(listaActividades){
    ...
    function clickInfo(btn){
        ...
        $.get(`/flujo/mostrarTipoDocActivDeNodoFlujo/${idNodoFlujo}`,function(resultado){
        ...
        $('#frm_flujo_eliminar').prop('action',window.location.protocol+'//'+window.location.host+'/flujo/gestion/'+idNodoFlujo);
    ...
    $("#btn_flujo_cancelar").click(function(){
        // deleccionamos todos los combos
            ...
            // -- combo de periodo --
            $(".gf_select_periodo").prop("selected", false);
            $("#pf_activo").prop("selected", true);
            $("#gf_select_periodo").trigger("chosen:updated");
            ...
            $("#conten_periodo").removeClass("disabled_content");
        ...
        // mostramos los botones finalizar, documentos, actividades
            $("#content_finalizar_add_cod_act").show();
    ...
    $("#btn_agregarNodo").click(function(){
        ...
        //RESTRICCION DE DEPARTAMENTO EN EL COMBO DE DEPARTAMENTO DESTINO
            $.get("/flujo/filtratFlujosHijos/"+idNodoFlujo, function(resultado){
            ...
            $("#conten_periodo").addClass("disabled_content");
