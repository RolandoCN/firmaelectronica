...
// ======================= FUNCIONES PARA REGISTRAR LA TEMINACIÓN ==============================
        ...
        $("#frm_registrarDenegacion").submit(function(e){
            ...
            swal({
                title: "",
                text: "¿Está seguro que desea denegar el trámite?",
                type: "info",
                showCancelButton: true,
                confirmButtonClass: "btn-danger",
                confirmButtonText: "Si, denegarlo!",
                ...
                if(isConfirm){ // si dice que quiere eliminar
                    ...
                    $.ajax({
                        ...
                        error: function(error){
                            alertNotificar("Error al realizar el registro", "error");
                            vistacargando(); // ocultamos la ventana de espera
                        }
                    }); 
