...
// ============================ METODOS PARA LA GESTIÓN DE CONTROL PROCESO ==================================
    ...
    function sector_editar_controlp(id){
        $.get("/gestionControlProceso/controlProceso/"+id+"/edit", function (resultado) {
        ...
        $('#frm_controlP').attr('action','/gestionControlProceso/controlProceso/'+id); // actualizamos la ruta del formulario para actualizar
    ...
    $('#btn_controlP_cancelar').click(function(){
        ...
        $('#frm_controlP').attr('action','/gestionControlProceso/controlProceso'); // agregamos la ruta post (ruta por defecto)
